    ...
    public class MarkBoard
    {
        ...
        static void TallyAllItems()
        {
            ...
            TallyItems(e.Something_With_Microsoft_Logo, new string[]{
                jonathanPeppers, geraldVersluis, samanthaHouts, steveHawley, rachelKang, ezHart, shaneNeuville, ruiMarinho, jonathanDick, alexSoto, ruiMarinho,
            });
            ...
            TallyItems(e.Sock_With_A_Hole_In_It, new string[]{
                geraldVersluis, tjLambert, samanthaHouts, shaneNeuville, steveHawley, ruiMarinho, alexSoto, jonathanPeppers,
            });

            TallyItems(e.Baby_Childhood_Photo, new string[]{
                steveHawley, samanthaHouts, geraldVersluis, tjLambert, shaneNeuville, ruiMarinho, ezHart, jonathanPeppers, alexSoto, rachelKang,
            });
            ...
            TallyItems(e.Imitate_Your_Favorite_Emoji, new string[]{
                samanthaHouts, steveHawley, geraldVersluis, rachelKang, shaneNeuville, alexSoto, ruiMarinho, jonathanDick, jonathanPeppers,
            });

            TallyItems(e.Decoration_With_A_Quote_On_It, new string[]{
                steveHawley, geraldVersluis, shaneNeuville, ruiMarinho, jonathanDick, alexSoto, jonathanPeppers, samanthaHouts,
            });
            ...
            TallyItems(e.Something_That_Begins_With_The_Letter_Z, new string[]{
                steveHawley, geraldVersluis, shaneNeuville, alexSoto, ruiMarinho, rachelKang, jonathanPeppers,
            });
            ...
            TallyItems(e.A_Cloud_That_Looks_Like_An_Animal, new string[]{
                steveHawley, shaneNeuville, alexSoto, jonathanPeppers, ruiMarinho, geraldVersluis, rachelKang,
            });
        }
